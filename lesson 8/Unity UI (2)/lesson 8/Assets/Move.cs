...
public class Move_Lession6 : MonoBehaviour
{
    ...
    public void Move()
    {
        ...
        {
            Quaternion deltaRotationRight = Quaternion.Euler(rotationLeft * Time.deltaTime);
            rb.MoveRotation(rb.rotation * deltaRotationRight);
        }
        if (Input.GetKey(KeyCode.RightArrow))
        {
            Quaternion deltaRotationLeft = Quaternion.Euler(rotationRight * Time.deltaTime);
